...
//function used to check password qualifications
var passwordCheckOld = function () 
{
    var stringPassword, arrayBadPasswords, stringOutput;
    //assigns value the user input for their password to stringPassword
    ...
    stringOutput = "";
 /*the .length function makes sure stringPassword meets length criteria
  *and the .includes function tests stringPassword against the values in the array*/
    if (stringPassword.length < 8 || arrayBadPasswords.includes(stringPassword))
    {
        stringOutput = "No";
    } else stringOutput = "Yes";
    $("output").value = stringOutput; //uses DOM input to send value of stringOutput back to the HTML
};
