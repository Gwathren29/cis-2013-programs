...
var generate = function () 
{
    ...
    {
        $("output").value = "Invalid Input, Please Try Again";
        $("total_fib").value = "";
    } else {
    ...
    //i and j initialize the sequence with actual calculations, stringOutput puts into output
    while (intCount > 2) {
        k = i + j;
        i = j;
        j = k;
